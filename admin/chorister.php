									...
									<tbody>
										...
										while($rowUsers= $stmuser->fetch()){
											...
											<tr class="gradeA">
												...
												<td class="center">
													<a href="chorister-edit.php?userId=<?php  echo $userId; ?>" type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-primary" title="Edit User">
														<i class="fa fa-edit"></i></a>
													<a href= "chorister-delete.php?userId=<?php  echo $userId; ?>" onclick="return confirm('Are you sure you want to delete chorister <?php echo $fname; ?> ?')" type="button" class="mb-xs mt-xs mr-xs btn btn-xs btn-danger" title="Delete event">
